...
- Before task creation, require child execution PRDs under `docs/prd/tasks|features|modules|components|subsystems/*.md`; do not jump directly from system PRD to `task add`.
