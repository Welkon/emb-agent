...
- If `next` returns `agent_protocol.gate.kind=prd-exploration`, ask detailed requirement/behavior questions, update `docs/prd/system.md`, `.emb-agent/req.yaml`, and child execution PRDs, then stop until explicit agreement.
