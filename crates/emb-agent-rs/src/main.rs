...
use emb_agent_core::{
    ...
    build_context_monitor_output, build_debug_output_json, build_do_output_json, build_health_json,
    build_hook_plan, build_hook_plan_json, build_hooks_diagnostics_json,
    build_host_session_start_payload, build_next_json, build_plan_output_json,
    build_project_state_json, build_project_state_paths_json, build_review_output_json,
    build_scan_output_json, build_session_context, build_start_json, build_status_json,
    build_statusline, build_task_list_json, build_task_show_json, build_verify_output_json,
    build_welcome_message, get_project_state_paths, json_string_field, project_state_from_cwd,
