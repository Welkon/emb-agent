...
fn print_default_user_flow() {
    println!(
        ...
        [
            ...
            "  3. /emb-start      create, repair, or refresh project context",
            "  4. /emb-next       choose exactly one most useful next action",
            "  5. /emb-finish-work close verified work with a workspace journal",
            "  6. task            create or continue focused work after context exists",
            "",
            "Recommended first step: /emb-start",
            "Continue existing work: /emb-next",
